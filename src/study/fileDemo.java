...
public class fileDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		instance.NLPIR_AddUserWord("支付宝");
		instance.NLPIR_AddUserWord("理财通");
		instance.NLPIR_AddUserWord("财付通");
		instance.NLPIR_AddUserWord("取现");
		instance.NLPIR_AddUserWord("提现");
		instance.NLPIR_AddUserWord("透支提现");
		instance.NLPIR_AddUserWord("取款");
		instance.NLPIR_AddUserWord("提款");
		instance.NLPIR_AddUserWord("扣款");
		instance.NLPIR_AddUserWord("帐户");
		instance.NLPIR_AddUserWord("借记");
		instance.NLPIR_AddUserWord("预借");
		instance.NLPIR_AddUserWord("手续费");
		instance.NLPIR_AddUserWord("利息手续费");
		instance.NLPIR_AddUserWord("账务");
		instance.NLPIR_AddUserWord("转入");
		instance.NLPIR_AddUserWord("还款");
		instance.NLPIR_AddUserWord("客服");
		instance.NLPIR_AddUserWord("支付宝入账");
		
		
		try {
/////////////////文件/////////////////////////////////////////////////////////////////
			String encoding="GBK";
			File file=new File("d:\\fenci\\test.txt");
			//FileWriter filewriter=new FileWriter("d:\\fenci\\bc.result.txt");
			if(file.isFile() & file.exists()){
				...
				while((linetxt=bufferReader.readLine())!=null){
					...
					resultString=instance.NLPIR_ParagraphProcess(linetxt,1);
				...
				Writers.hashTableWritter(wordcount, "D:/fenci/test.result.txt");
